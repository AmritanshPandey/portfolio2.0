...
export function ProcessStepsCard({ steps }: { steps: Step[] }) {
  return (
    <div className="relative rounded-3xl p-8 md:p-12 bg-card text-card-foreground border border-border overflow-hidden">
      <div className="pointer-events-none absolute inset-y-0 left-0 w-20 bg-gradient-to-r from-[rgba(16,185,129,0.08)] via-[rgba(16,185,129,0.04)] to-transparent blur-xl opacity-70" />
      <div className="pointer-events-none absolute -top-28 -right-28 w-[300px] h-[300px] bg-[radial-gradient(circle,rgba(16,185,129,0.06),transparent_70%)] dark:bg-[radial-gradient(circle,rgba(52,211,153,0.12),transparent_70%)] blur-3xl" />
      <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(110deg,transparent,rgba(16,185,129,0.04),transparent)] dark:bg-[linear-gradient(110deg,transparent,rgba(52,211,153,0.06),transparent)] opacity-50" />
