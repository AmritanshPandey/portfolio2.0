  ...
  return (
    <>
      <div className="relative left-1/2 w-screen -translate-x-1/2">
        <FullBleedBlock
          src="/assets/images/work/white-label-platform.jpg"
          alt="White-label wallet interface shown as a full-bleed case-study hero"
          aspect="screen"
          eyebrow="Case study template"
          title="Marketeq wallet"
          subtitle="A centralized balance surface for returning consulting clients who need to reuse funds across projects, states, and currencies."
          priority
          flush
          className="my-0"
        />
