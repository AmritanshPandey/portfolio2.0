...
const ACCENT = "linear-gradient(135deg, #fb923c 0%, #f97316 45%, #c2410c 100%)"
  ...
  return (
    ...
    >
      ...
      <span
        ...
        style={{ fontSize: "240px", color: "rgba(255,255,255,0.05)" }}
      >
        C
      </span>
      ...
      <div className="relative z-10 w-full max-w-4xl mx-auto px-6 pb-14 pt-32 space-y-5">
        <div className="flex flex-wrap items-center gap-3">
          ...
          <span className="flex items-center gap-1.5 text-[12px] text-white/60">
            <IconClock size={12} />{a.readTime}
          </span>
          <span className="flex items-center gap-1.5 text-[12px] text-white/60">
            <IconCalendar size={12} />{a.date}
          </span>
        </div>
